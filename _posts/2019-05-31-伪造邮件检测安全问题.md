...
layout: post
title:伪造邮件检测安全问题
date: 2019-05-31 18:56
tags:
- research
- web
categories: research
description: 伪造邮件检测安全问题，段老师课程论文阅读
---
...
![smtp 邮件传输过程](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/smtp-transmission.png)
...
![使用情况](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/SRF-DMARC-usage.png)

可以看到 SPF 和 DMARC 采用率在以低速增长。并且截至 17 年末，SRF 使用率已经达到 40%。其中阴影的部分是发布了拒绝策略的比例。

下表也显示了 2018 年 1 月最新的的探测结果统计数据：

![SPF/DMARC statistics of Alexa 1 million domains.](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/spf-dmarc-stat.png)
...
![End-to-end spoofing experiment setup](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/spoof-experiment.png)
...
![inbox rate](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/inbox-rate.png)

对实验结果的分析就不在博客了赘述了，贴出一些因子的对比图：

![The aggregated rato of emails that reached the user inbox (inbox rate).](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/aggrated-rato.png)
...
![Feature ranking](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/feature-rank.png)
...
![安全警示图](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/security-indicators.png)
...
![Misleading UI elements](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/mislead-UI.png)
...
![Seznam.cz](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/Seznam.png)
...
![The phishing email screenshot](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/phishing-email.png)
...
#### 3.2 招募参与者 (Recruiting Participants)
...
![User study statistics for different user-agents](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/user-study-stat.png)
...
security indicators on click rates](../assets/img/papers/End-to-End-Measurements-of-Email-Spoofing-Attacks/demographic-factors.png)
